package hy.rpg.enum
{
	...
	public final class EnumDirection
	{
		 ...
		 * 左边五向
		 */
		public static const leftFiveDirs : Array = [EnumDirection.WEST, EnumDirection.WEST_NORTH, EnumDirection.WEST_SOUTH, EnumDirection.SOUTH, EnumDirection.NORTH];
		/**
		 * 右边五向
		 */
		public static const rightFiveDirs : Array = [EnumDirection.EAST, EnumDirection.EAST_NORTH, EnumDirection.EAST_SOUTH, EnumDirection.SOUTH, EnumDirection.NORTH];
		/**
		 * 左边一向
		 */
		public static const leftOneDirs : Array = [EnumDirection.WEST];
		/**
		 * 右边一向
		 */
		public static const rightOneDirs : Array = [EnumDirection.EAST];
		/**
		 * 横两向
		 */
		public static const twoHorDirs : Array = [EnumDirection.EAST, EnumDirection.WEST];
		/**
		 * 纵一向
		 */
		public static const twoVerDirs : Array = [EnumDirection.NORTH, EnumDirection.SOUTH];
		/**
		 * 斜两向
		 */
		public static const twoDiaDirs : Array = [EnumDirection.EAST_NORTH, EnumDirection.EAST_SOUTH, EnumDirection.WEST_NORTH, EnumDirection.WEST_SOUTH];
		/**
		 * 八向
		 */
		public static const eightDirs : Array = [EnumDirection.EAST, EnumDirection.NORTH, EnumDirection.SOUTH, EnumDirection.WEST, EnumDirection.EAST_NORTH, EnumDirection.WEST_NORTH, EnumDirection.EAST_SOUTH, EnumDirection.WEST_SOUTH];

		/**
		 * 以左边3向为镜像向右翻转
		 */
		public static const leftReverseDirs : Array = [EnumDirection.EAST, EnumDirection.EAST_NORTH, EnumDirection.EAST_SOUTH];
		/**
		 * 以右边3向为镜像向左翻转
		 */
		public static const rightReverseDirs : Array = [EnumDirection.WEST, EnumDirection.WEST_NORTH, EnumDirection.WEST_SOUTH];
		...
		public static function getReversalDirs(dirs : Array) : Array
		{
			...
			{
				var revesalDir : int = UtilsCommon.getReverseDirByDir(dirs[i]); //取反向
		...
		public static function getXPlusMinusByDir(dir : uint, lastDir : uint = 0) : int
		{
			...
			switch (dir)
			{
				...
				case EnumDirection.SOUTH:
				case EnumDirection.NORTH:
					if (lastDir == EnumDirection.WEST || lastDir == EnumDirection.WEST_NORTH || lastDir == EnumDirection.WEST_SOUTH)
						plusMinus = -1;
					break;
				case EnumDirection.WEST:
				case EnumDirection.WEST_SOUTH:
		...
		public static function getYPlusMinusByDir(dir : uint, lastDir : uint = 0) : int
		{
			...
			switch (dir)
			{
				...
				case EnumDirection.EAST_SOUTH:
				case EnumDirection.WEST_SOUTH:
					if (lastDir == EnumDirection.NORTH || lastDir == EnumDirection.EAST_NORTH || lastDir == EnumDirection.WEST_NORTH)
						plusMinus = -1;
					break;
				case EnumDirection.NORTH:
				case EnumDirection.EAST_NORTH:
